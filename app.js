...
function filteredItems() {
  return menuItems.filter(item => (state.filter === "all" || item.type === state.filter) && (state.category === "All" || item.category === state.category) && item.name.toLowerCase().includes(state.search.toLowerCase()));
}
